...
const experiences: ExperienceItem[] = [
  {
    ...
    description:
      "Envolvido em deploy, pipelines e infraestrutura de aplicações, incluindo Docker, CI/CD e provisionamento em servidores. Atuação direta em reuniões com clientes, conduzindo alinhamentos técnicos, levantamento de requisitos e contribuindo na definição de arquiteturas de projetos. Desenvolvimento full stack com foco em entrega contínua e alinhamento técnico com as necessidades do negócio.",
    details: [
      "Desenvolvimento de sistemas voltados para Lean Manufacturing, otimizando processos produtivos, rastreabilidade e indicadores de eficiência (OEE, produtividade, perdas operacionais), com impacto direto na tomada de decisão do cliente",
